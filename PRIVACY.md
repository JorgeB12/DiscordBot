...
Bemol **no tiene base de datos** y **no guarda información de forma permanente**. Mientras está en un canal de voz mantiene en memoria, solo durante la sesión:
...
Toda esa información se borra cuando Bemol sale del canal de voz, cuando se vacía la cola o cuando el bot se reinicia.
...
Como Bemol no conserva datos, no hay nada que solicitar ni borrar: al salir del canal de voz o expulsar al bot del servidor, la información en memoria desaparece. Si tienes dudas, contacta con el responsable del bot en el servidor de soporte indicado en `/ayuda`.
